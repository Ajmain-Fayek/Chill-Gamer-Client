...
const AddReviews = () => {
    ...
    return (
        ...
        >
            ...
            <div className="w-fit mx-auto backdrop-blur-sm">
                <Fade duration={600}>
                    <div className="space-y-6 w-fit text-white bg-gray-950/50 rounded-xl border border-gray-600 shadow-md mx-auto p-6 sm:px-8 sm:py-10 lg:px-12 backdrop-blur-sm">
                        ...
                        >
                            <p className="drop-shadow-[0_0_5px_#374151] flex items-center gap-1.5 py-1 px-2">
                                <FaArrowLeft style={{ fontSize: ".7rem" }} />{" "}
                                Back to home
                            </p>
                        </Link>
                        <div className="space-y-3 max-w-screen-md mx-auto bg-transparent px-6 py-12 rounded-lg">
                            <div className="text-center max-w-screen-sm mx-auto">
                                ...
                                <p className="text-white drop-shadow-[0_0_5px_#374151]">
                                    Other game lovers might get hepful insights
                                    from your reviews. A best gamer is always
                                    help other gamers.
                                </p>
                            </div>
                            <div>
